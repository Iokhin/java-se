 ...
 * 2019-06-18T17:16:51.416+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "SessionEndpointBeanService",
                  wsdlLocation = "http://127.0.0.1:80/SessionEndpointBean?wsdl",
...
public class SessionEndpointBeanService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:80/SessionEndpointBean?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SessionEndpointBeanService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:80/SessionEndpointBean?wsdl");
        }
        WSDL_LOCATION = url;
    }
