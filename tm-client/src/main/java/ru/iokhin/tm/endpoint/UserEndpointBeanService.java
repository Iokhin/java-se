 ...
 * 2019-06-18T17:16:51.909+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointBeanService",
                  wsdlLocation = "http://127.0.0.1:80/UserEndpointBean?wsdl",
...
public class UserEndpointBeanService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:80/UserEndpointBean?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointBeanService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:80/UserEndpointBean?wsdl");
        }
        WSDL_LOCATION = url;
    }
